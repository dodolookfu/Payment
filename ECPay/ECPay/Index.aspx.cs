                ...
                if (amount != null && name != null) {
                    ...
                    try {
                        using (AllInOne oPayment = new AllInOne()) {
                            ...
                            /* 基本參數 */
                            oPayment.Send.ReturnURL = "http://localhost:4596/ReturnPage.aspx"; //付款完成通知回傳的網址
                            oPayment.Send.ClientBackURL = "http://localhost:4596/index.aspx";
                            oPayment.Send.OrderResultURL = "http://localhost:4596//ReturnPage.aspx";
                            ...
                            oPayment.Send.TotalAmount = Decimal.Parse(amount);//Decimal.Parse("3280");//交易總金額
                            ...
                            oPayment.Send.Items.Add(new Item() {
                                Name = name,//商品名稱
                                Price = Decimal.Parse(amount),//商品單價
                                Currency = "新台幣",//幣別單位
                        ...
                        if (enErrors.Count() > 0) {
                            ...
                            Response.Write(string.Format("<script language='javascript'>alert('{0}！');</script>", szErrorMessage));
                        }
                    }
                }
            }
